...
function vedioList(data){
    ...
    $.each(data.movieList, function (index, val) {
        //modified by yangyb at 2016/10/13将界面直接加载为播放器 begin
        ///*影片简介信息*/
        ...
        //name="+val.vedioPath+"&image="+val.imagePath+
        source.setAttribute("src","/movie/"+val.vedioPath+"/out.m3u8");
        ...
        //modified by yangyb at 2016/10/13将界面直接加载为播放器 end
        
        document.getElementById('vedioList').appendChild(video);
