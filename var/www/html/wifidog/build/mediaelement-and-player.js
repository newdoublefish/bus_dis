...
mejs.HtmlMediaElementShim = {
    ...
    determinePlayback: function(a, b, c, d, e) {
        ...
        if (!d && q.length > 0 && null !== q[0].url && this.getTypeFromFile(q[0].url).indexOf("audio") > -1 && (r.isVideo = !1), mejs.MediaFeatures.isBustedAndroid && (a.canPlayType = function(a) {
            ...
            for (d || (o = document.createElement(r.isVideo ? "video": "audio"), a.parentNode.insertBefore(o, a), a.style.display = "none", r.htmlMediaElement = a = o), f = 0; f < q.length; f++) if ("" !== a.canPlayType(q[f].type).replace(/no/, "") || "" !== a.canPlayType(q[f].type.replace(/mp3/, "mpeg")).replace(/no/, "") || "" !== a.canPlayType(q[f].type.replace(/m4a/, "mp4")).replace(/no/, "")) {
                r.method = "native",
                r.url = q[f].url;
                break
            }
        ...
        if ("auto" === b.mode || "auto_plugin" === b.mode || "shim" === b.mode) for (f = 0; f < q.length; f++) for (k = q[f].type, g = 0; g < b.plugins.length; g++) for (l = b.plugins[g], m = mejs.plugins[l], h = 0; h < m.length; h++) if (n = m[h], null == n.version || mejs.PluginDetector.hasPluginVersion(l, n.version)) for (i = 0; i < n.types.length; i++) if (k == n.types[i]) return r.method = l,
        r.url = q[f].url,
        r;
    ...
    createPlugin: function(a, b, c, d, e, f) {
        ...
        case "vimeo":
            var s = m + "_player";
            if (n.vimeoid = a.url.substr(a.url.lastIndexOf("/") + 1), o.innerHTML = '<iframe src="//player.vimeo.com/video/' + n.vimeoid + "?api=1&portrait=0&byline=0&title=0&player_id=" + s + '" width="' + k + '" height="' + l + '" frameborder="0" class="mejs-shim" id="' + s + '"></iframe>', "function" == typeof $f) {
...
function(a) {
    ...
    "undefined" == typeof a.zh && (a.zh = {
        Fullscreen: "鍏ㄨ灑骞?,"Go Fullscreen ":"鍏ㄥ睆妯″紡","Turn off Fullscreen ":"閫€鍑哄叏灞忔ā寮 ? ,
        Close: "闂滈枆"
    })
} (mejs.i18n.locale.strings),
...
function(a) {
    ...
    mejs.MediaElementPlayer = function(b, c) {
        ...
        "undefined" != typeof d.node.player ? d.node.player: (d.node.player = d, "undefined" == typeof c && (c = d.$node.data("mejsoptions")), d.options = a.extend({},
        mejs.MepDefaults, c), d.id = "mep_" + mejs.mepIndex++, mejs.players[d.id] = d, d.init(), d)
    },
    mejs.MediaElementPlayer.prototype = {
        ...
        init: function() {
            ...
            c.isiPad && null !== b.media.getAttribute("autoplay") && b.play();
                ...
                b.width = b.options[g + "Width"] > 0 || b.options[g + "Width"].toString().indexOf("%") > -1 ? b.options[g + "Width"] : "" !== b.media.style.width && null !== b.media.style.width ? b.media.style.width: null !== b.media.getAttribute("width") ? b.$media.attr("width") : b.options["default" + h + "Width"],
                b.height = b.options[g + "Height"] > 0 || b.options[g + "Height"].toString().indexOf("%") > -1 ? b.options[g + "Height"] : "" !== b.media.style.height && null !== b.media.style.height ? b.media.style.height: null !== b.$media[0].getAttribute("height") ? b.$media.attr("height") : b.options["default" + h + "Height"],
        ...
        hideControls: function(b) {
            ...
            c.controlsAreVisible && !c.options.alwaysShowControls && (b ? (c.controls.stop(!0, !0).fadeOut(200,
            function() {
        ...
        meReady: function(a, b) {
            ...
            if (!e.created) {
                if (e.created = !0, e.media = a, e.domNode = b, !(f.isAndroid && e.options.AndroidUseNativeControls || f.isiPad && e.options.iPadUseNativeControls || f.isiPhone && e.options.iPhoneUseNativeControls)) {
                    e.buildposter(e, e.controls, e.layers, e.media),
                    e.buildkeyboard(e, e.controls, e.layers, e.media),
                    e.buildoverlays(e, e.controls, e.layers, e.media),
                    e.findTracks();
                    for (c in e.options.features) if (d = e.options.features[c], e["build" + d]) try {
                        e["build" + d](e, e.controls, e.layers, e.media)
                    } catch(i) {
                        console.log("error building " + d),
                        console.log(i)
                    }
                    e.container.trigger("controlsready"),
                    e.setPlayerSize(e.width, e.height),
                    e.setControlsSize(),
                    e.isVideo && (mejs.MediaFeatures.hasTouch ? e.$media.bind("touchstart",
                    function() {
                        e.controlsAreVisible ? e.hideControls(!1) : e.controlsEnabled && e.showControls(!1)
                    }) : (e.clickToPlayPauseCallback = function() {
                        e.options.clickToPlayPause && (e.media.paused ? e.play() : e.pause())
                    },
                    e.media.addEventListener("click", e.clickToPlayPauseCallback, !1), e.container.bind("mouseenter mouseover",
                    function() {
                    ...
                    })), e.options.hideVideoControlsOnLoad && e.hideControls(!1), h && !e.options.alwaysShowControls && e.hideControls(), e.options.enableAutosize && e.media.addEventListener("loadedmetadata",
                    function(a) {
                    ...
                    function() {
                        ...
                        for (a in mejs.players) {
                            ...
                            b.id == e.id || !e.options.pauseOtherPlayers || b.paused || b.ended || b.pause(),
                            b.hasFocus = !1
                        }
                        e.hasFocus = !0
                    },
                    !1),
                    e.media.addEventListener("ended",
                    function() {
                        ...
                        e.options.loop ? e.play() : !e.options.alwaysShowControls && e.controlsEnabled && e.showControls()
                    },
                    !1),
                    e.media.addEventListener("loadedmetadata",
                    function() {
                        e.updateDuration && e.updateDuration(),
                        e.updateCurrent && e.updateCurrent(),
                    ...
                    e.globalBind("resize",
                    function() {
                        e.isFullScreen || mejs.MediaFeatures.hasTrueNativeFullScreen && document.webkitIsFullScreen || e.setPlayerSize(e.width, e.height),
                        e.setControlsSize()
                    }),
                    "youtube" == e.media.pluginType && e.container.find(".mejs-overlay-play").hide()
                }
                h && "native" == a.pluginType && e.play(),
                e.options.success && ("string" == typeof e.options.success ? window[e.options.success](e.media, e.domNode, e) : e.options.success(e.media, e.domNode, e))
            }
        },
        ...
        setPlayerSize: function(b, c) {
            ...
            if ("undefined" != typeof b && (d.width = b), "undefined" != typeof c && (d.height = c), d.height.toString().indexOf("%") > 0 || "100%" === d.$node.css("max-width") || parseInt(d.$node.css("max-width").replace(/px/, ""), 10) / d.$node.offsetParent().width() === 1 || d.$node[0].currentStyle && "100%" === d.$node[0].currentStyle.maxWidth) {
                ...
                isNaN(h) && (h = d.container.parent().closest(":visible").height()),
                "body" === d.container.parent()[0].tagName.toLowerCase() && (g = a(window).width(), h = a(window).height()),
                0 != h && 0 != g && (d.container.width(g).height(h), d.$media.add(d.container.find(".mejs-shim")).width("100%").height("100%"), d.isVideo && d.media.setVideoSize && d.media.setVideoSize(g, h), d.layers.children(".mejs-layer").width("100%").height("100%"))
            ...
            i.height(d.container.height() - d.controls.height()),
            j.css("margin-top", "-" + (j.height() / 2 - d.controls.height() / 2).toString() + "px")
        },
        setControlsSize: function() {
            ...
            if (b.container.is(":visible") && e.length && e.is(":visible")) {
                b.options && !b.options.autosizeProgress && (d = parseInt(e.css("width"))),
        ...
        buildoverlays: function(b, c, d, e) {
            ...
            if (b.isVideo) {
                ...
                i = a('<div class="mejs-overlay mejs-layer mejs-overlay-play"><div class="mejs-overlay-button"></div></div>').appendTo(d).bind("click touchstart",
                function() {
        ...
        buildkeyboard: function(b, c, d, e) {
            ...
            function(a) {
                if (b.hasFocus && b.options.enableKeyboard) for (var c = 0,
                d = b.options.keyActions.length; d > c; c++) for (var f = b.options.keyActions[c], g = 0, h = f.keys.length; h > g; g++) if (a.keyCode == f.keys[g]) return a.preventDefault(),
                f.action(b, e, a.keyCode),
                !1;
                return ! 0
            }),
            f.globalBind("click",
        ...
        remove: function() {
            ...
            c.isDynamic ? c.$node.insertBefore(c.container) : (c.$media.prop("controls", !0), c.$node.clone().show().insertBefore(c.container), c.$node.remove()),
        ...
        buildstop: function(b, c, d, e) {
            {
                ...
                a('<div class="mejs-button mejs-stop-button mejs-stop"><button type="button" aria-controls="' + f.id + '" title="' + f.options.stopText + '" aria-label="' + f.options.stopText + '"></button></div>').appendTo(c).click(function() {
                    e.paused || e.pause(),
                    e.currentTime > 0 && (e.setCurrentTime(0), e.pause(), c.find(".mejs-time-current").width("0px"), c.find(".mejs-time-handle").css("left", "0px"), c.find(".mejs-time-float-current").html(mejs.Utility.secondsToTimeCode(0)), c.find(".mejs-currenttime").html(mejs.Utility.secondsToTimeCode(0)), d.find(".mejs-poster").show())
                })
            }
        }
    })
...
function(a) {
    a.extend(MediaElementPlayer.prototype, {
        buildprogress: function(b, c, d, e) {
            ...
            m = function(a) {
                if (a.originalEvent.changedTouches) var b = a.originalEvent.changedTouches[0].pageX;
                else var b = a.pageX;
                var c = g.offset(),
                d = g.outerWidth(!0),
                f = 0,
            ...
            function(a) {
                return 1 === a.which || 0 === a.which ? (n = !0, m(a), f.globalBind("mousemove.dur touchmove.dur",
                function(a) {
                    m(a)
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        enterFullScreen: function() {
            ...
            if ("native" === b.media.pluginType || !mejs.MediaFeatures.isFirefox && !b.options.usePluginFullScreen) {
                if (a(document.documentElement).addClass("mejs-fullscreen"), normalHeight = b.container.height(), normalWidth = b.container.width(), "native" === b.media.pluginType) if (mejs.MediaFeatures.hasTrueNativeFullScreen) mejs.MediaFeatures.requestFullScreen(b.container[0]),
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        buildtracks: function(b, c, d, e) {
            if (0 != b.tracks.length) {
                ...
                for (g.options.toggleCaptionsButtonWhenOnlyOne && 1 == h ? b.captionsButton.on("click",
                function() {
        ...
        loadTrack: function(b) {
            ...
            a.ajax({
                ...
                dataType: "text",
                success: function(a) {
                    d.entries = "string" == typeof a && /<tt\s+xml/gi.exec(a) ? mejs.TrackFormatParser.dfxp.parse(a) : mejs.TrackFormatParser.webvvt.parse(a),
                    e(),
        ...
        enableTrackButton: function(b, c) {
            ...
            d.options.startLanguage == b && a("#" + d.id + "_captions_" + b).click(),
            d.adjustLanguageBox()
        },
        ...
        displayCaptions: function() {
            if ("undefined" != typeof this.tracks) {
                ...
                if (null != c && c.isLoaded) {
                    for (a = 0; a < c.entries.times.length; a++) if (b.media.currentTime >= c.entries.times[a].start && b.media.currentTime <= c.entries.times[a].stop) return b.captionsText.html(c.entries.text[a]),
    ...
    mejs.TrackFormatParser = {
        webvvt: {
            ...
            parse: function(b) {
                for (var c, d, e = 0,
                f = mejs.TrackFormatParser.split2(b, /\r?\n/), g = {
                    text: [],
                    times: []
