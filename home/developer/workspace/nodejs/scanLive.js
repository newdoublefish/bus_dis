...
var root = path.join("/home/developer/workspace/hls")
...
function createMovie()
{
	...
	obj.getInsertSql=function()
	{
        ...
        var sql="insert into live_table (Name,ImagePath,VedioPath) values ('"+this.Name+"','"+this.ImagePath+"','"+this.VedioPath+"')";	
		return sql;
	}
	return obj;
}
...
var db =new sqlite3.Database('/home/developer/workspace/database/demo.db',function(){
	...
	var delsql = "delete from live_table";
